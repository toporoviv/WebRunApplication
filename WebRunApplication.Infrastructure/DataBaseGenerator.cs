...
public static class DataBaseGenerator
{
    ...
    public static List<HelpMessage> GenerateHelps()
    {
        return new List<HelpMessage>
        {
            new HelpMessage { UserId = 1, Question = "Как выйти из приложения?", Answer = "...", Date = new DateTime(2022, 5, 23) },
            new HelpMessage
            {
                UserId = 3,
            ...
            new HelpMessage { UserId = 7, Question = "Можно ли вводить показатели вручную?", Answer = "Нет", Date = new DateTime(2022, 8, 11) },
            new HelpMessage
            {
                UserId = 9,
    ...
    public static List<TrainingTemplateType> GenerateTemplateTypes()
    {
        return new List<TrainingTemplateType>
        {
            new TrainingTemplateType { TemplateId = 1, TrainingTypeId = 8 },
            new TrainingTemplateType { TemplateId = 1, TrainingTypeId = 7 },
            new TrainingTemplateType { TemplateId = 1, TrainingTypeId = 9 },
            new TrainingTemplateType { TemplateId = 2, TrainingTypeId = 8 },
            new TrainingTemplateType { TemplateId = 2, TrainingTypeId = 3 },
            new TrainingTemplateType { TemplateId = 2, TrainingTypeId = 4 },
            new TrainingTemplateType { TemplateId = 2, TrainingTypeId = 9 },
            new TrainingTemplateType { TemplateId = 3, TrainingTypeId = 8 },
            new TrainingTemplateType { TemplateId = 3, TrainingTypeId = 1 },
            new TrainingTemplateType { TemplateId = 4, TrainingTypeId = 8 },
            new TrainingTemplateType { TemplateId = 4, TrainingTypeId = 4 },
            new TrainingTemplateType { TemplateId = 4, TrainingTypeId = 5 },
            new TrainingTemplateType { TemplateId = 4, TrainingTypeId = 9 },
            new TrainingTemplateType { TemplateId = 5, TrainingTypeId = 8 },
            new TrainingTemplateType { TemplateId = 5, TrainingTypeId = 6 },
            new TrainingTemplateType { TemplateId = 5, TrainingTypeId = 9 }
        };
    }
    ...
    public static List<MailingMessage> GenerateMailings()
    {
        return new List<MailingMessage>
        {
            new MailingMessage { Date = DateTime.Now, MailingTopicId = 1, Message = "Первая рассылка" }
        };
    }
